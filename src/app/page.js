...
export default function LandingPage() {
  ...
  return (
    <div
      className="min-h-screen font-sans overflow-x-hidden flex flex-col items-center"
      style={{
    ...
    >
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-12 w-full">
        {/* ParticleRing as background */}
        <div className="absolute inset-0 z-0 pointer-events-none">
          <ParticleRing />
        </div>
        {/* Hero content */}
        <div className="container mx-auto px-4 py-20 flex flex-col items-center text-center max-w-4xl z-10 relative">
          <Motion.div className="mb-8">
            <div className="inline-block px-4 py-2 bg-yellow-900/30 backdrop-blur-sm rounded-full mb-6 border border-yellow-700/50">
             ...
             <Motion.div
          className="absolute bottom-1 left-1/2 transform -translate-x-1/4 flex flex-col items-center z-10"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 1.5 }}
        >
          <span className="text-xs mb-2 text-yellow-400">Scroll to discover</span>
          <div className="w-7 h-10 rounded-full border-2 border-yellow-400 flex justify-center p-1">
            <Motion.div
              animate={{ y: [0, 10, 0] }}
          ...
          <Motion.div className="flex flex-col sm:flex-row gap-6 hero-buttons">
            <Motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-gradient-to-r from-yellow-500 to-yellow-600 text-black font-medium rounded-lg transition-all duration-300 transform shadow-lg shadow-yellow-500/30 flex items-center justify-center min-w-[180px] text-lg"
            ...
            <Link href="/learnmore" className="w-full sm:w-auto">
              <Motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-transparent border-2 border-yellow-500 text-yellow-400 font-medium rounded-lg hover:bg-yellow-500/10 transition-all duration-300 text-lg w-full"
              >
                Learn more
              </Motion.button>
            </Link>
